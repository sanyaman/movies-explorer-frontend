    ...
    return (
        <section className='about-project' id={`learn-more`}>
            ...
            <div className='about-project__week'>
                <div className='about-project__section-box'>
                    <h4 className='about-project__week-line about-project__week-line_backend'>1 неделя</h4>
                    <p className='about-project__week-description'>Back-end</p>
                </div>
                <div className='about-project__section-box'>
                    <h4 className='about-project__week-line about-project__week-line_frontend'>4 недели</h4>
